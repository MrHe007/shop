                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="list-group">
                            ...
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=0" class="list-group-item"><span class="badge"><!-- 这里写数量，暂时搁置 --></span>全部</a>
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=2" class="list-group-item"><span class="badge"></span>生活出行</a>
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=1" class="list-group-item"><span class="badge"></span>书籍</a>
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=5" class="list-group-item"><span class="badge"></span>体育运动</a>
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=4" class="list-group-item"><span class="badge"></span>电子产品</a>
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=3" class="list-group-item"><span class="badge"></span>衣物鞋包</a>
                            <a href="../out/artifacts/hfuu_shop_master_war_exploded/index.jsp?ceta=6" class="list-group-item"><span class="badge"></span>其他</a>
                        </div>
                    </div>
                </div>
            </div>
